function [tc, results] = gcc_linaro_arm_linux_gnueabihf()
...
make.IncludeFiles = {'codertarget_assembly_flags.mk', '../codertarget_assembly_flags.mk', '../../codertarget_assembly_flags.mk', '$(ALL_DEPS)'};
